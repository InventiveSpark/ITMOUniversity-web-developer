/* Примечание: По умолчанию консоль очищается каждый раз, когда вы открываете
   ...
   если страница была перезагружена из-за отправки формы. Чтобы переопределить
   это поведение браузера, нужно открыть консоль, нажать иконку в виде
   шестеренки в правом верхнем углу и установить флажок "Persist Logs" (FireFox)
   или "Preserve log" (Chrome).
