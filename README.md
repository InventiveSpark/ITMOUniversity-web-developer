...
# [Модуль 5. Средства организации процесса веб-разработки в команде](Module_5/)
## [Тема 1. Системы контроля версий. Репозиторий Git](Module_5/loschenkov_Git1)
## [Тема 2. Ветвление в Git](Module_5/loschenkov_Git2)
## [Тема 3. Использование Git на сервере. Распределенная работа в Git](Module_5/loschenkov_Git3) ([репозиторий*](https://gitlab.com/InventiveSpark/itmouniversity-web-developer-module_5-independent-work_3))
...
# [Модуль 6. PHP и MySQL. Основы разработки веб-приложений](Module_6/)
## [Тема 1. Установка языка программирования PHP](Module_6/loschenkov_PHP1)
## [Тема 2. Структура файла PHP. Переменные, алгоритмические структуры](Module_6/loschenkov_PHP2)
## [Тема 3. Подключение внешних файлов. Константы](Module_6/loschenkov_PHP3)
## [Тема 4. Массивы. Строки. Циклы](Module_6/loschenkov_PHP4)
## [Тема 5. Пользовательские функции](Module_6/loschenkov_PHP5)
## [Тема 6. Глобальные массивы GET и POST](Module_6/loschenkov_PHP6)
## Тема 7. Сессии и куки
